...
const Resume = () => {
  return (
    <div className="min-h-screen bg-gradient-to-b from-black to-gray-900 text-white py-20 relative">
      <div className="container mx-auto px-4">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="relative pl-8 space-y-16">
            {/* Timeline line */}
            <div className="absolute left-0 top-0 bottom-0 w-0.5 bg-red-500/20"></div>
            
            {/* Education Section */}
            <div className="relative animate-fade-up">
              <div className="absolute -left-8 p-2 rounded-full bg-black border border-red-500">
